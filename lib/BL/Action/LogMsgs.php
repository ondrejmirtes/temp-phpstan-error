...
final class BL_Action_LogMsgs{
	...
	// Single use option below - Should be used in one place at appropriate entrance of code (action, start of script)
    	...
    	const __USER_SCHEDULE__					    = '__USER_SCHEDULE__';
    	...
    	const __GUEST_TERMINATED_BY_CRON_10__		= '__GUEST_TERMINATED_BY_CRON_10__';
    	const __AEONFLUX_TOOL__						= '__AEONFLUX_TOOL__';
    	const __COURSE_WIZARD__                     = '__COURSE_WIZARD__';
    	const __CONTENT_LAUNCHER__                  = '__CONTENT_LAUNCHER__'; 
    	const __USER_ATTRIBUTES_OVERWRITTEN_BY_SNAPSHOT__ = '__USER_ATTRIBUTES_OVERWRITTEN_BY_SNAPSHOT__';
    	const __TALIS01_API__                       = '__TALIS01_API__';
	...
	// Single use option below
	    ...
	    self::__USER_SCHEDULE__					    => 'User scheduled their event enrollment',
	...
	// General multi-use options below
	    ...
	    self::__TALIS01_API__                       => 'Talis01 API ',
	...
	// DATAFIX options
		...
		self::__AEONFLUX_TOOL__						=> 'Aeonflux Tool: ',
        self::__CLOUD_CME_DEGREE_CE_CREDIT_UPDATE__ => 'Cloud CME update user degree and ce credit category id',
		self::__GUEST_TERMINATED_BY_CRON_10__		=> 'Guest account terminated by cron 10 because of active organization',
	    self::__COURSE_WIZARD__                     => 'course wizard',
	    self::__CONTENT_LAUNCHER__                  => 'Content Launcher ',
	    self::__USER_ATTRIBUTES_OVERWRITTEN_BY_SNAPSHOT__ => 'Overwritten by user snapshot system.'
	];
