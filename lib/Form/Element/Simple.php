...
class Form_Element_Simple{
	protected	$name		= '',
				...
				$last_used_validator_error_message = ''
	;
	...
	public function validate(){
		foreach($this->validators as $validator){
			if(!$validator->validate($this->v())){
				...
				$this->last_used_validator_error_message = $validator->message();
				return false;
			}
		}
		return true;
	...
	public function last_used_error_message(){
		return $this->last_used_validator_error_message;
	}
	/**
	 * Return value
	 * 
