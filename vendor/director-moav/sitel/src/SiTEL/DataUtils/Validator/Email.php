...
class Email extends a{
     ...
     * @var string
     */
    protected string $message = 'The input is not a valid email address';
    ...
    public function validate($value):bool{
        ...
        if (!$atIndex){
            ...
            if (count($d_parts) < 2){
                ...
                return false;
            }elseif(stripos($value,'noemai') !== false){
                return false;
                ...
                return false;
            }elseif(stripos($value,'nomail') !== false){
                return false;
            }elseif(stripos($value,'momail') !== false){
                return false;
            }elseif(stripos($value,'noeamil@medstar.net') !== false){
                return false;
            }elseif(stripos($value,'Credentialing@emaonline') !== false){
                return false;
            }elseif(stripos($value,'@montgomerygeneral.com') !== false){
                return false;
            }elseif(stripos($value,'@medstarmontgomery.com') !== false){
                return false;
            }elseif(stripos($value,'@mestar.com') !== false){
                return false;
            }elseif(stripos($value,'@mail.com') !== false){
                return false;
            }elseif(stripos($value,'@associates.com') !== false){
                return false;
            }elseif(stripos($value,'@umh.sitel.org') !== false){
                return false;
            }
        }
        return true;
